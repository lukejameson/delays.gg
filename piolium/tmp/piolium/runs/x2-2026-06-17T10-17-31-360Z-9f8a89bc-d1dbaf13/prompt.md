# Run x2-2026-06-17T10-17-31-360Z-9f8a89bc-d1dbaf13
...
Target file (anchor): `apps/web/src/lib/server/debug-helpers.ts`
Language: TypeScript
Rank in this run: 32/87  ·  Heuristic score: 110
File hash slug: 9f8a89bc
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-9f8a89bc-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/lib/server/debug-helpers.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 32 of 87).
