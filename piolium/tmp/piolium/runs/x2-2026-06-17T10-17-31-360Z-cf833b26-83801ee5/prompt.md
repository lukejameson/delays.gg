# Run x2-2026-06-17T10-17-31-360Z-cf833b26-83801ee5
...
Target file (anchor): `apps/web/src/routes/stats/lib/types.ts`
Language: TypeScript
Rank in this run: 55/87  ·  Heuristic score: 9
File hash slug: cf833b26
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-cf833b26-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/stats/lib/types.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 55 of 87).
