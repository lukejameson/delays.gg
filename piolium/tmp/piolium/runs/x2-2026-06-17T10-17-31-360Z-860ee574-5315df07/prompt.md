# Run x2-2026-06-17T10-17-31-360Z-860ee574-5315df07
...
Target file (anchor): `apps/web/src/routes/stats/+page.server.ts`
Language: TypeScript
Rank in this run: 5/87  ·  Heuristic score: 279
File hash slug: 860ee574
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-860ee574-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/stats/+page.server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 5 of 87).
