# Run x2-2026-06-17T10-17-31-360Z-3e69cba5-893a6066
...
Target file (anchor): `apps/web/vite.config.ts`
Language: TypeScript
Rank in this run: 42/87  ·  Heuristic score: 59
File hash slug: 3e69cba5
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-3e69cba5-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/vite.config.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 42 of 87).
