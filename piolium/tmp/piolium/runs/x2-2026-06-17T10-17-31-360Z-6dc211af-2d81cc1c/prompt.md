# Run x2-2026-06-17T10-17-31-360Z-6dc211af-2d81cc1c
...
Target file (anchor): `apps/web/src/lib/statusConfig.ts`
Language: TypeScript
Rank in this run: 79/87  ·  Heuristic score: 0
File hash slug: 6dc211af
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-6dc211af-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/lib/statusConfig.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 79 of 87).
