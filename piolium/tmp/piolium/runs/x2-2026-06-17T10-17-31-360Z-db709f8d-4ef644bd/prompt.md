# Run x2-2026-06-17T10-17-31-360Z-db709f8d-4ef644bd
...
Target file (anchor): `apps/guernsey-scraper/src/scraper.ts`
Language: TypeScript
Rank in this run: 9/87  ·  Heuristic score: 265
File hash slug: db709f8d
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-db709f8d-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/guernsey-scraper/src/scraper.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 9 of 87).
