# Run x2-2026-06-17T10-17-31-360Z-c3374319-7bbb9fc1
...
Target file (anchor): `apps/web/src/routes/stats/lib/queries.ts`
Language: TypeScript
Rank in this run: 2/87  ·  Heuristic score: 320
File hash slug: c3374319
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-c3374319-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/stats/lib/queries.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 2 of 87).
