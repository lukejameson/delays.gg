# Run x2-2026-06-17T10-17-31-360Z-a5732c4d-f54ec3b6
...
Target file (anchor): `apps/web/src/routes/api/debug/positions/+server.ts`
Language: TypeScript
Rank in this run: 23/87  ·  Heuristic score: 199
File hash slug: a5732c4d
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-a5732c4d-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/positions/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 23 of 87).
