# Run x2-2026-06-17T10-17-31-360Z-a2504b7b-60adae82
...
Target file (anchor): `apps/web/src/routes/api/debug/ui/search/+server.ts`
Language: TypeScript
Rank in this run: 26/87  ·  Heuristic score: 196
File hash slug: a2504b7b
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-a2504b7b-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/ui/search/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 26 of 87).
