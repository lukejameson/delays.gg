# Run x2-2026-06-17T10-17-31-360Z-a7b59fb0-6f9bf7cd
...
Target file (anchor): `apps/notification-service/src/dispatcher.ts`
Language: TypeScript
Rank in this run: 56/87  ·  Heuristic score: 9
File hash slug: a7b59fb0
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-a7b59fb0-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/notification-service/src/dispatcher.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 56 of 87).
