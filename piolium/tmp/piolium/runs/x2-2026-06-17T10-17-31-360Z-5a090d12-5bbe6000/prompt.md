# Run x2-2026-06-17T10-17-31-360Z-5a090d12-5bbe6000
...
Target file (anchor): `apps/web/src/hooks.server.ts`
Language: TypeScript
Rank in this run: 4/87  ·  Heuristic score: 292
File hash slug: 5a090d12
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-5a090d12-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/hooks.server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 4 of 87).
