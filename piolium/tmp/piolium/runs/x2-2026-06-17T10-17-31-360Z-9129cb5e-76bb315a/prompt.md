# Run x2-2026-06-17T10-17-31-360Z-9129cb5e-76bb315a
...
Target file (anchor): `apps/adsb-service/src/lookup.ts`
Language: TypeScript
Rank in this run: 41/87  ·  Heuristic score: 60
File hash slug: 9129cb5e
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-9129cb5e-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/adsb-service/src/lookup.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 41 of 87).
