# Run x2-2026-06-17T10-17-31-360Z-71487cd5-32130cfd
...
Target file (anchor): `apps/web/src/routes/api/debug/status-history/+server.ts`
Language: TypeScript
Rank in this run: 11/87  ·  Heuristic score: 265
File hash slug: 71487cd5
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-71487cd5-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/status-history/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 11 of 87).
