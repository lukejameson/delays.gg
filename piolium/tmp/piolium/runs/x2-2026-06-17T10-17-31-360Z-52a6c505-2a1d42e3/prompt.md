# Run x2-2026-06-17T10-17-31-360Z-52a6c505-2a1d42e3
...
Target file (anchor): `apps/guernsey-scraper/src/index.ts`
Language: TypeScript
Rank in this run: 81/87  ·  Heuristic score: 0
File hash slug: 52a6c505
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-52a6c505-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/guernsey-scraper/src/index.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 81 of 87).
