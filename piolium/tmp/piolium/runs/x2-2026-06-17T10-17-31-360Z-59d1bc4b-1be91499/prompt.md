# Run x2-2026-06-17T10-17-31-360Z-59d1bc4b-1be91499
...
Target file (anchor): `apps/guernsey-scraper/src/live.ts`
Language: TypeScript
Rank in this run: 40/87  ·  Heuristic score: 61
File hash slug: 59d1bc4b
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-59d1bc4b-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/guernsey-scraper/src/live.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 40 of 87).
