# Run x2-2026-06-17T10-17-31-360Z-96379105-4e437fe0
...
Target file (anchor): `apps/web/src/routes/api/debug/flights/+server.ts`
Language: TypeScript
Rank in this run: 10/87  ·  Heuristic score: 265
File hash slug: 96379105
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-96379105-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/flights/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 10 of 87).
