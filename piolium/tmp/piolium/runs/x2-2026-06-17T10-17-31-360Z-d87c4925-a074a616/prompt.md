# Run x2-2026-06-17T10-17-31-360Z-d87c4925-a074a616
...
Target file (anchor): `apps/adsb-service/src/index.ts`
Language: TypeScript
Rank in this run: 48/87  ·  Heuristic score: 55
File hash slug: d87c4925
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-d87c4925-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/adsb-service/src/index.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 48 of 87).
