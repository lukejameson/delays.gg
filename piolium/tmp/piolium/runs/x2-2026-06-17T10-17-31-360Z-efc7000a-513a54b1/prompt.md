# Run x2-2026-06-17T10-17-31-360Z-efc7000a-513a54b1
...
Target file (anchor): `packages/common/src/env.ts`
Language: TypeScript
Rank in this run: 45/87  ·  Heuristic score: 55
File hash slug: efc7000a
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-efc7000a-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/common/src/env.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 45 of 87).
