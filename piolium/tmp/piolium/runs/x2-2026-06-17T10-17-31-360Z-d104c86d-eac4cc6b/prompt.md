# Run x2-2026-06-17T10-17-31-360Z-d104c86d-eac4cc6b
...
Target file (anchor): `apps/fr24-scraper/src/scraper.ts`
Language: TypeScript
Rank in this run: 3/87  ·  Heuristic score: 295
File hash slug: d104c86d
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-d104c86d-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/fr24-scraper/src/scraper.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 3 of 87).
