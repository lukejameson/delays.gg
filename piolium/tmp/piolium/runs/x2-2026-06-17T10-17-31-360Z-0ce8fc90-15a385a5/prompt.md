# Run x2-2026-06-17T10-17-31-360Z-0ce8fc90-15a385a5
...
Target file (anchor): `packages/telegram/src/index.ts`
Language: TypeScript
Rank in this run: 37/87  ·  Heuristic score: 70
File hash slug: 0ce8fc90
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-0ce8fc90-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/telegram/src/index.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 37 of 87).
