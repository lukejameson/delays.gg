# Run x2-2026-06-17T10-17-31-360Z-e8be093f-9dc455a6
...
Target file (anchor): `packages/database/schema.ts`
Language: TypeScript
Rank in this run: 49/87  ·  Heuristic score: 32
File hash slug: e8be093f
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-e8be093f-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/database/schema.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 49 of 87).
