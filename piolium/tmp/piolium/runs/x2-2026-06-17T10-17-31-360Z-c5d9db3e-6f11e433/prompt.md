# Run x2-2026-06-17T10-17-31-360Z-c5d9db3e-6f11e433
...
Target file (anchor): `packages/database/singleton.ts`
Language: TypeScript
Rank in this run: 31/87  ·  Heuristic score: 115
File hash slug: c5d9db3e
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-c5d9db3e-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/database/singleton.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 31 of 87).
