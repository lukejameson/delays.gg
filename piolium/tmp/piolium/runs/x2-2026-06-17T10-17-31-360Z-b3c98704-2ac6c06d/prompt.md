# Run x2-2026-06-17T10-17-31-360Z-b3c98704-2ac6c06d
...
Target file (anchor): `apps/web/src/lib/components/index.ts`
Language: TypeScript
Rank in this run: 85/87  ·  Heuristic score: 0
File hash slug: b3c98704
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-b3c98704-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/lib/components/index.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 85 of 87).
