# Run x2-2026-06-17T10-17-31-360Z-d60fb374-2f1511cb
...
Target file (anchor): `apps/adsb-service/src/fleet.ts`
Language: TypeScript
Rank in this run: 73/87  ·  Heuristic score: 0
File hash slug: d60fb374
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-d60fb374-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/adsb-service/src/fleet.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 73 of 87).
