# Run x2-2026-06-17T10-17-31-360Z-b560d22a-4ff18a89
...
Target file (anchor): `apps/web/src/lib/server/db.ts`
Language: TypeScript
Rank in this run: 62/87  ·  Heuristic score: 3
File hash slug: b560d22a
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-b560d22a-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/lib/server/db.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 62 of 87).
