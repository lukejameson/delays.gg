# Run x2-2026-06-17T10-17-31-360Z-d5d04db9-8c6fed86
...
Target file (anchor): `scripts/debug-weather-join.ts`
Language: TypeScript
Rank in this run: 19/87  ·  Heuristic score: 241
File hash slug: d5d04db9
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-d5d04db9-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: scripts/debug-weather-join.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 19 of 87).
