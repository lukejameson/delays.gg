# Run x2-2026-06-17T10-17-31-360Z-9bb77161-1811eed5
...
Target file (anchor): `apps/web/src/routes/api/debug/ui/flight/[id]/+server.ts`
Language: TypeScript
Rank in this run: 50/87  ·  Heuristic score: 24
File hash slug: 9bb77161
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-9bb77161-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/ui/flight/[id]/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 50 of 87).
