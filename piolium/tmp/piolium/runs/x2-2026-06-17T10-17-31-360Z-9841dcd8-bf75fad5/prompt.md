# Run x2-2026-06-17T10-17-31-360Z-9841dcd8-bf75fad5
...
Target file (anchor): `apps/web/src/routes/api/debug/airports/+server.ts`
Language: TypeScript
Rank in this run: 33/87  ·  Heuristic score: 107
File hash slug: 9841dcd8
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-9841dcd8-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/airports/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 33 of 87).
