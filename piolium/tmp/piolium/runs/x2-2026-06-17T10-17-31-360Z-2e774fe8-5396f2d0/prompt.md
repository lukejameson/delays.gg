# Run x2-2026-06-17T10-17-31-360Z-2e774fe8-5396f2d0
...
Target file (anchor): `apps/web/src/service-worker.ts`
Language: TypeScript
Rank in this run: 30/87  ·  Heuristic score: 115
File hash slug: 2e774fe8
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-2e774fe8-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/service-worker.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 30 of 87).
