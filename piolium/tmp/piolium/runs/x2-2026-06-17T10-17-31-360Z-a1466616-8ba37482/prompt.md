# Run x2-2026-06-17T10-17-31-360Z-a1466616-8ba37482
...
Target file (anchor): `apps/web/src/routes/search/+page.server.ts`
Language: TypeScript
Rank in this run: 27/87  ·  Heuristic score: 160
File hash slug: a1466616
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-a1466616-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/search/+page.server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 27 of 87).
