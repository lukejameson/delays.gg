# Run x2-2026-06-17T10-17-31-360Z-16c9d7fd-930700bb
...
Target file (anchor): `apps/web/src/routes/flights/[id]/+page.server.ts`
Language: TypeScript
Rank in this run: 51/87  ·  Heuristic score: 23
File hash slug: 16c9d7fd
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-16c9d7fd-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/flights/[id]/+page.server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 51 of 87).
