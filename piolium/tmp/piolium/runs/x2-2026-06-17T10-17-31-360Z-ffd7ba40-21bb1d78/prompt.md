# Run x2-2026-06-17T10-17-31-360Z-ffd7ba40-21bb1d78
...
Target file (anchor): `apps/web/src/routes/api/push/check/[flightId]/+server.ts`
Language: TypeScript
Rank in this run: 43/87  ·  Heuristic score: 58
File hash slug: ffd7ba40
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-ffd7ba40-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/push/check/[flightId]/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 43 of 87).
