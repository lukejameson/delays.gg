# Run x2-2026-06-17T10-17-31-360Z-db875254-77c2bc16
...
Target file (anchor): `apps/web/src/routes/+page.server.ts`
Language: TypeScript
Rank in this run: 8/87  ·  Heuristic score: 267
File hash slug: db875254
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-db875254-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/+page.server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 8 of 87).
