# Run x2-2026-06-17T10-17-31-360Z-0dc3052e-89034f90
...
Target file (anchor): `apps/web/src/routes/api/debug/flight-times/+server.ts`
Language: TypeScript
Rank in this run: 34/87  ·  Heuristic score: 107
File hash slug: 0dc3052e
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-0dc3052e-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/flight-times/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 34 of 87).
