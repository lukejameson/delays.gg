# Run x2-2026-06-17T10-17-31-360Z-cad49483-71afb511
...
Target file (anchor): `apps/web/src/routes/api/debug/flight-notes/+server.ts`
Language: TypeScript
Rank in this run: 24/87  ·  Heuristic score: 199
File hash slug: cad49483
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-cad49483-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/flight-notes/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 24 of 87).
