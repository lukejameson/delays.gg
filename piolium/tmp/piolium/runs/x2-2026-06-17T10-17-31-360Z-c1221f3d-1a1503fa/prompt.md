# Run x2-2026-06-17T10-17-31-360Z-c1221f3d-1a1503fa
...
Target file (anchor): `packages/database/scheduler.ts`
Language: TypeScript
Rank in this run: 7/87  ·  Heuristic score: 268
File hash slug: c1221f3d
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-c1221f3d-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/database/scheduler.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 7 of 87).
