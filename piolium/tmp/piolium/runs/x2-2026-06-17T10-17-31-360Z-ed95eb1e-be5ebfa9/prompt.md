# Run x2-2026-06-17T10-17-31-360Z-ed95eb1e-be5ebfa9
...
Target file (anchor): `apps/web/src/lib/types/index.ts`
Language: TypeScript
Rank in this run: 77/87  ·  Heuristic score: 0
File hash slug: ed95eb1e
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-ed95eb1e-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/lib/types/index.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 77 of 87).
