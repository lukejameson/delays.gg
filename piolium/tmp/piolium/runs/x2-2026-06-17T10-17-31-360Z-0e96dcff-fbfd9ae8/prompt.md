# Run x2-2026-06-17T10-17-31-360Z-0e96dcff-fbfd9ae8
...
Target file (anchor): `apps/web/src/routes/api/debug/push-subs/+server.ts`
Language: TypeScript
Rank in this run: 18/87  ·  Heuristic score: 245
File hash slug: 0e96dcff
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-0e96dcff-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/push-subs/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 18 of 87).
