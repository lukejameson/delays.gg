# Run x2-2026-06-17T10-17-31-360Z-0c60f88c-5c21c98c
...
Target file (anchor): `packages/common/src/index.ts`
Language: TypeScript
Rank in this run: 71/87  ·  Heuristic score: 0
File hash slug: 0c60f88c
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-0c60f88c-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/common/src/index.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 71 of 87).
