# Run x2-2026-06-17T10-17-31-360Z-d517a00e-79010216
...
Target file (anchor): `apps/web/src/routes/api/debug/ui/homepage/+server.ts`
Language: TypeScript
Rank in this run: 13/87  ·  Heuristic score: 262
File hash slug: d517a00e
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-d517a00e-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/ui/homepage/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 13 of 87).
