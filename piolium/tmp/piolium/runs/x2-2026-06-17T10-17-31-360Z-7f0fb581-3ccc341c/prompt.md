# Run x2-2026-06-17T10-17-31-360Z-7f0fb581-3ccc341c
...
Target file (anchor): `packages/common/src/types.ts`
Language: TypeScript
Rank in this run: 72/87  ·  Heuristic score: 0
File hash slug: 7f0fb581
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-7f0fb581-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/common/src/types.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 72 of 87).
