# Run x2-2026-06-17T10-17-31-360Z-b1b2b937-1fcc65df
...
Target file (anchor): `apps/web/src/lib/airports.ts`
Language: TypeScript
Rank in this run: 69/87  ·  Heuristic score: 0
File hash slug: b1b2b937
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-b1b2b937-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/lib/airports.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 69 of 87).
