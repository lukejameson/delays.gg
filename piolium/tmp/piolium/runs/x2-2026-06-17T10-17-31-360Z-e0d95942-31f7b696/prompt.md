# Run x2-2026-06-17T10-17-31-360Z-e0d95942-31f7b696
...
Target file (anchor): `apps/web/src/routes/api/debug/ui/stats/+server.ts`
Language: TypeScript
Rank in this run: 6/87  ·  Heuristic score: 275
File hash slug: e0d95942
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-e0d95942-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/ui/stats/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 6 of 87).
