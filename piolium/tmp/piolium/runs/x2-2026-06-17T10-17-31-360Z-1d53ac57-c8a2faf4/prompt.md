# Run x2-2026-06-17T10-17-31-360Z-1d53ac57-c8a2faf4
...
Target file (anchor): `apps/weather-service/src/airports.ts`
Language: TypeScript
Rank in this run: 39/87  ·  Heuristic score: 64
File hash slug: 1d53ac57
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-1d53ac57-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/weather-service/src/airports.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 39 of 87).
