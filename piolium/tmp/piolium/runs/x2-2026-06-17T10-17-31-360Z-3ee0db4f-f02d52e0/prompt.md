# Run x2-2026-06-17T10-17-31-360Z-3ee0db4f-f02d52e0
...
Target file (anchor): `apps/web/src/lib/delays.ts`
Language: TypeScript
Rank in this run: 66/87  ·  Heuristic score: 0
File hash slug: 3ee0db4f
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-3ee0db4f-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/lib/delays.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 66 of 87).
