# Run x2-2026-06-17T10-17-31-360Z-16201ecf-fc6b8ff5
...
Target file (anchor): `apps/web/src/routes/api/debug/sql/+server.ts`
Language: TypeScript
Rank in this run: 12/87  ·  Heuristic score: 262
File hash slug: 16201ecf
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-16201ecf-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/sql/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 12 of 87).
