# Run x2-2026-06-17T10-17-31-360Z-d9f2f2b5-a0b99fb7
...
Target file (anchor): `apps/web/src/routes/api/push/subscribe/+server.ts`
Language: TypeScript
Rank in this run: 57/87  ·  Heuristic score: 9
File hash slug: d9f2f2b5
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-d9f2f2b5-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/push/subscribe/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 57 of 87).
