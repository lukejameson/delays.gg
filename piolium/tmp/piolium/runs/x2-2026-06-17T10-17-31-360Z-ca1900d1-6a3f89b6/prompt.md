# Run x2-2026-06-17T10-17-31-360Z-ca1900d1-6a3f89b6
...
Target file (anchor): `apps/web/src/routes/api/debug/notification-watermark/+server.ts`
Language: TypeScript
Rank in this run: 53/87  ·  Heuristic score: 12
File hash slug: ca1900d1
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-ca1900d1-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/notification-watermark/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 53 of 87).
