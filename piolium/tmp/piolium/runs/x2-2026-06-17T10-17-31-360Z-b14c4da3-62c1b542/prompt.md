# Run x2-2026-06-17T10-17-31-360Z-b14c4da3-62c1b542
...
Target file (anchor): `apps/web/src/routes/sitemap.xml/+server.ts`
Language: TypeScript
Rank in this run: 36/87  ·  Heuristic score: 71
File hash slug: b14c4da3
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-b14c4da3-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/sitemap.xml/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 36 of 87).
