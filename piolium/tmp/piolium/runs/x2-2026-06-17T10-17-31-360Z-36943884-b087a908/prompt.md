# Run x2-2026-06-17T10-17-31-360Z-36943884-b087a908
...
Target file (anchor): `apps/web/src/routes/flights/[id]/lib/map.ts`
Language: TypeScript
Rank in this run: 60/87  ·  Heuristic score: 5
File hash slug: 36943884
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-36943884-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/flights/[id]/lib/map.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 60 of 87).
