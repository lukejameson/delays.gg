# Run x2-2026-06-17T10-17-31-360Z-2f6d1839-f431e2c1
...
Target file (anchor): `apps/web/src/routes/api/debug/scrapers/+server.ts`
Language: TypeScript
Rank in this run: 17/87  ·  Heuristic score: 245
File hash slug: 2f6d1839
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-2f6d1839-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/api/debug/scrapers/+server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 17 of 87).
