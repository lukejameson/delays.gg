# Run x2-2026-06-17T10-17-31-360Z-f52ecf0b-39d5b1a8
...
Target file (anchor): `packages/common/src/timezone.ts`
Language: TypeScript
Rank in this run: 78/87  ·  Heuristic score: 0
File hash slug: f52ecf0b
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-f52ecf0b-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/common/src/timezone.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 78 of 87).
