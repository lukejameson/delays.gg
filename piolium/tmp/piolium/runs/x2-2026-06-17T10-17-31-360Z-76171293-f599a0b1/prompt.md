# Run x2-2026-06-17T10-17-31-360Z-76171293-f599a0b1
...
Target file (anchor): `apps/position-service/src/poller.ts`
Language: TypeScript
Rank in this run: 28/87  ·  Heuristic score: 146
File hash slug: 76171293
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-76171293-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/position-service/src/poller.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 28 of 87).
