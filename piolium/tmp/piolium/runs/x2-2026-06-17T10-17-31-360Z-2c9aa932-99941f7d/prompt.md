# Run x2-2026-06-17T10-17-31-360Z-2c9aa932-99941f7d
...
Target file (anchor): `apps/web/src/routes/+layout.server.ts`
Language: TypeScript
Rank in this run: 59/87  ·  Heuristic score: 5
File hash slug: 2c9aa932
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-2c9aa932-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/+layout.server.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 59 of 87).
