# Run x2-2026-06-17T10-17-31-360Z-928b7c95-1a789860
...
Target file (anchor): `packages/database/statusPriority.ts`
Language: TypeScript
Rank in this run: 83/87  ·  Heuristic score: 0
File hash slug: 928b7c95
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-928b7c95-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: packages/database/statusPriority.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 83 of 87).
