# Run x2-2026-06-17T10-17-31-360Z-37dd5058-5fe430e0
...
Target file (anchor): `apps/web/src/routes/stats/lib/stores.ts`
Language: TypeScript
Rank in this run: 15/87  ·  Heuristic score: 255
File hash slug: 37dd5058
...
For every concrete finding, write a draft to `piolium/findings-draft/longshot-37dd5058-NNN-<slug>.md` (NNN starts at 001 for this anchor).
...
Operator notes:
- Anchor file: apps/web/src/routes/stats/lib/stores.ts
- Language: TypeScript
- Per-file timeout: 21600000ms
- This is a single tile in a swarm of 87 parallel hunts (rank 15 of 87).
